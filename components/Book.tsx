    ...
    <section className="h-full w-full relative">
      ...
      <div className="h-full flex items-center max-w-7xl mx-auto px-4 lg:px-0 py-16">
        <div className="flex flex-col justify-center items-center w-full gap-8">
          <h2 className="font-ppeditorialnew text-4xl lg:text-6xl text-[#EFF0DE] tracking-[0.5px] z-10 pb-4">
            Book Your Date Now
          </h2>
          <div className="bg-[#183621] flex flex-col items-center justify-center rounded-none z-10 py-12 gap-8 px-4 lg:px-8 shadow-lg">
            <div className="flex flex-col items-center gap-4 text-center">
              <h6 className="font-ppeditorialnew text-2xl lg:text-4xl text-[#EFF0DE] tracking-[0.5px]">
                Ready to escape to paradise?
              </h6>
              <p className="text-[#EFF0DE] font-satoshi text-sm lg:text-base tracking-[0.5px]">
